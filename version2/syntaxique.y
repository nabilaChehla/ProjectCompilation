...
;
Fonction_i: type_fonc ROUTINE_mc idf par_ouvrante ARG par_fermante DEC INSTRUCTIONS Affectation ENDR_mc Fonction_i {add_TYPE_Cst_Idf($3,top(stack_type));pop(stack_type)}
           | 
;
